...
(function ($) {
    ...
    $(window).load(function () {
        ...
        $(".inner-left").css("height", moHeight);
        $(".inner-noslit").css("height", moHeight);
        //ajax demo fn
        ...
        $("a[rel='append-content']").click(function (e) {
            ...
            $.get(url, function (data) {
                ...
                $("#content_1").mCustomScrollbar("scrollTo", "h2:last", { scrollInertia: 0, scrollEasing: "easeInOutQuad" }); //scroll to appended content
            });
        });
    });
})(jQuery);
